...
<body>
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="#"><i class="material-icons">camera_alt</i>Sell</a>
    </li>
    <li class="nav-item">
	...
	<div class="row text">
		<div class="col-xl-12 col-md-12 col-sm-12">
			...
			<button class="btn btn-dark">Start  Selling</button>
			</a>
		</div>
	...
	<div class="container-fluid">
		<div class="row text0">
			<div class="col-xl-12 col-md-12 col-sm-12 text-center">
				<a href="sellerLogin.jsp">
				<button class="btn" style="margin-bottom:50px; margin-top: 20px;">Sell</button>
				</a>
			</div>
		</div>
