...
<nav class="navbar navbar-expand-sm teal lighten-1 justify-content-end fixed-top">
   <span class="logo">
		  <a href="ProductProfile.jsp?rqno=<%=rqid%>" >
		  <img src="assets/antixbicycle.jpg"/></a>
  ...
  <ul class="navbar-nav">
	...
	<div class="row black" style="width: 100%; height: 8vh; z-index: 200;"></div>
		...
		<div class="row login-form">
				...
				<form method="post" action="buyerAuth?rqno=<%=rqid%>">
				...
				<a href="sellerSignup.jsp?rqno=<%=rqid %>" class="btn2">
